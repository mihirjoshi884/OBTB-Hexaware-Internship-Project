...
- Angular application in `frontend/obtb-app/`
- Vercel account connected to GitHub
- Backend API URLs from OCI deployment
...
1. **Create Vercel Project**
   ...
   - Select the `frontend/obtb-app` directory as the root directory
   - Configure build settings:
     - Framework Preset: Angular
     - Build Command: `npm run build`
     - Output Directory: `dist/obtb-app`
...
2. **Environment Variables**
   ...
   - Add production environment variables:
     ```
     API_BASE_URL=https://your-oci-instance-public-ip:8080
     AUTH_BASE_URL=https://your-oci-instance-public-ip:8081
     ```
     - Replace `your-oci-instance-public-ip` with your OCI instance's public IP
     - Set environment to "Production"

3. **Build Configuration**
   - Ensure `angular.json` has correct output path:
     ```json
     "outputPath": "dist/obtb-app"
     ```
   - Update `src/environments/environment.prod.ts`:
     ```typescript
     export const environment = {
       production: true,
       apiBaseUrl: 'https://your-oci-instance-public-ip:8080',
       authBaseUrl: 'https://your-oci-instance-public-ip:8081'
     };
     ```
...
4. **Deploy**
   ...
   - Access your app at the generated Vercel URL (e.g., `https://obtb-app.vercel.app`)
...
- Builds are triggered on GitHub pushes
...
## 4. Production Dockerfile Template
...
10. Deploy the Angular frontend on Vercel with backend API URLs.
11. Configure Vercel frontend with the correct backend API URLs.
