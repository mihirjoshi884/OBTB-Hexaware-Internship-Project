...
public class UserControllerTest {
    ...
    void testCreateUser() throws Exception {
        ...
        // Stub the service
        when(userService.addUser(any(UserCreationRequest.class))).thenReturn(mockSummary);
    ...
    void testGetUser() throws Exception {
        when(userService.getUser(any(UUID.class))).thenReturn(mockSummary);
    ...
    void testGetUserEmail() throws Exception {
        when(userService.getEmail(userId)).thenReturn("john@email.com");
